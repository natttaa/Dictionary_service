...
Ожидаемый вывод:
```
2026/03/20 10:00:00 Сервис-2 запущен на :8081
...
Ожидаемый вывод:
```
2026/03/20 10:00:05 Сервис-1 запущен на :8080
2026/03/20 10:00:05 Подключение к Сервису-2: http://localhost:8081
```
